...
const oldForm = `          <p className="text-center text-slate-500 mb-10 text-lg font-medium">Sila masukkan ID Pengguna untuk mengakses sistem.</p>
          
          <form onSubmit={handleLogin} className="space-y-6">`;

const newForm = `          <p className="text-center text-slate-500 mb-10 text-lg font-medium">Log masuk ke Dashboard Pentadbir menggunakan akaun rasmi sekolah.</p>
...
code = code.replace(`placeholder="cth: tahfiz1"`, `placeholder="cth: admin@smakg3.edu.my"`);
code = code.replace(`ID Pengguna</label>`, `Emel Pentadbir</label>`);
